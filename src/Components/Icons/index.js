...
export const DesktopIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        fontSize="26px"
...
export const MessageIcon = forwardRef(({ className, width = '2.6rem', height = '2.6rem' }, ref) => (
    <svg
        ref={ref}
        className={className}
        width={width}
...
export const InboxIcon = forwardRef(({ className, width = '3.2rem', height = '3.2rem' }, ref) => (
    <svg
        ref={ref}
        className={className}
        width={width}
...
export const SearchIcon = forwardRef(({ className, width = '2.4rem', height = '2.4rem' }, ref) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
